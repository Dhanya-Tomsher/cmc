                            ...
                            <div class="card-body py-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" value="{{ $cat[0]->cat_state }}" readonly>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="origin" readonly class="form-control" placeholder="Enter Origin / History">{{ $cat[0]->origin }} </textarea>
                                    </div>
                                        ...
                                        <form action="#">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" type="text" value="{{ $cat[0]->caretaker_state }}" readonly id="Emirate">
                                                </div>
