                                        ...
                                        accept=".jpg,.jpeg,.png,.gif,.bmp,.tiff,.webp">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <input class="form-control" type="text"  name="customer_id" value="{{ old('customer_id', $caretaker->customer_id) }}" id="example-text-input">
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <textarea name="address" value="{{ old('address', $caretaker->address) }}" class="form-control" placeholder="Enter address" rows="2"></textarea>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input class="form-control" name="phone_number" value="{{ old('phone_number', $caretaker->phone_number) }}" type="text" placeholder="Enter Phone Number" id="phone">
                                                </div>

                                                <div class="col-md-4">
                                                    <label for="whatsapp" class="col-form-label">Whatsapp Number</label>
                                                    <input class="form-control" name="whatsapp_number" value="{{ old('whatsapp_number', $caretaker->whatsapp_number) }}" type="text" placeholder="Enter Whatsapp Number" id="whatsapp">
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input class="form-control" name="work_place" value="{{ old('work_place', $caretaker->work_place) }}" type="text" placeholder="Enter Work Place">
                                                </div>

                                                <div class="col-md-4">
                                                    <label class="col-form-label">Work Address</label>
                                                    <input class="form-control" name="work_address" value="{{ old('work_address', $caretaker->work_address) }}" type="text" placeholder="Enter Work Address">
                                                </div>

                                                <div class="col-md-4">
                                                    <label class="col-form-label">Position</label>
                                                    <input class="form-control" name="position" value="{{ old('position', $caretaker->position) }}" type="text" placeholder="Enter Position">
                                                </div>

                                                <div class="col-md-4">
                                                    <label for="work-number" class="col-form-label">Work Contact Number</label>
                                                    <input class="form-control" name="work_contact_number" value="{{ old('work_contact_number', $caretaker->work_contact_number) }}" type="text" placeholder="Enter Work Contact Number" id="work-number">
                                                </div>
                                                ...
                                                <div class="col-md-4 passport_input align-items-center" id="myRadioGroup">
                                                   ...
                                                   <div class="d-flex align-items-center">
                                                    ...
                                                    <input class="form-control" type="text" name="passport_number" value="{{ old('passport_number', $caretaker->passport_number) }}" placeholder="Enter Passport No" id="input1" style="display: none;">
                                                   </div>
                                                </div>
                                                ...
                                                <div class="col-md-4 passport_input align-items-center" id="input3">
                                                   ...
                                                   <div class="d-flex align-items-center">
                                                    ...
                                                    <input class="form-control" name="emirates_id_number" value="{{ old('emirates_id_number', $caretaker->emirates_id_number) }}" type="text" placeholder="Enter Emirates ID" id="input2" style="display: none;">
                                                   </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select class="form-select form-control" name="visa_status" value="{{ old('visa_status', $caretaker->visa_status) }}">
                                                        <option>Select</option>
