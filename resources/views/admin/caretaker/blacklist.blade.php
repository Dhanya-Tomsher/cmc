        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Blacklisted Caretakers</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active"><a href="{{ route('caretaker.index') }}">Caretaker</a></li>
                            <li class="breadcrumb-item active">Blacklisted Caretaker</li>
                        </ol>
                    </div>
                    ...
                    <div class="search_warpper w-50">
                        <form>
                            <div class="hstack gap-2">
                                ...
                                <button type="button" class="btn btn_back waves-effect waves-light w-xl"
                                    onclick="getBlacklistedCaretakers()">Search</button>
                                <button type="button" class="btn btn_back waves-effect waves-light w-md"
                                    id="searchReset">Reset</button>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    getBlacklistedCaretakers();

    function getBlacklistedCaretakers() {
        var search = $('#search').val();
        $.ajax({
            url: "{{ route('caretaker.blacklist')}}",
            type: "POST",
            data: {
                search: search
            },
