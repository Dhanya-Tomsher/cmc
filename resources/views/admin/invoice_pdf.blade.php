                                    ...
                                    <table class="table table-nowrap table-centered mb-0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="width:20% !important;text-align: center; padding: 0 !important; vertical-align: top !important;">
                                                    <h5 class="mb-1" style="font-size:18px;">Invoice</h5>
                                                </td>
                                                <td style="width:40% !important;text-align: center; padding: 0 !important; vertical-align: top !important;">
                                ...
                                <div class="py-0">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table  table-centered mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope="row" colspan="5"  class="text-right"></th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end"> {{$net + $service_charge }}</td>
                                                </tr>
                                                ...
                                                <tr style="margin-top:10px;">
                                                    ...
                                                    <td class="text-right">{{$net + $service_charge }}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <h3 class="m-0" ><span style="font-size:15px;float:left;margin-top:4px;margin-left:6px;">AED </span>{{$total  }}</h3>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
