                        ...
                        <form name="frm" action="{{ route('form.store') }}" enctype="multipart/form-data"  method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-8 offset-md-2">
                                    ...
                                    <input class="form-control" name="title" value="{{ old('title') }}" type="text" placeholder="Enter form title" id="title">
                                    @error('title')
                                ...
                                <div class="col-md-8 offset-md-2">
                                   ...
                                   <textarea class="form-control content" name="content" value="{{ old('content') }}" placeholder="Enter form content" id="content"> </textarea>
                                    @error('content')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
