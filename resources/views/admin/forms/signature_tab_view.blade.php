                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 text-end">
                            <button name="Submit" type="Submit"  class="btn btn-primary waves-effect waves-light w-xl me-2 " onclick="window.location.reload()">Refresh</button>
                        </div>
                        <div class="col-sm-12">
                            ...
                            @if(isset($tab[0]) && $tab[0]->customer_form_id != NULL)
                                @if(isset($form[0]))
                                    ...
                                    <div class="row" style="margin-top: 3%; ">
                                        <div class="col-md-8 offset-md-2 border" style="background: white;">
                                            ...
                                            <div class="col-md-12 d-flex">
                                                ...
                                                <div class="col-md-7" @if($form[0]['signed_status']==1)
                                                    ...
                                                    <form method="POST" action="{{ route('signaturepad.upload') }}">
                                                        ...
                                                        <input type="hidden" id="tab" name="tab" value="{{ Request::segment(3) }}">
                                                        <label class="col-form-label"><b>Signature</b></label>
                                                        <div id="sig"></div>
