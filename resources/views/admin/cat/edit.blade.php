...
<form name="frm" action="{{ route('cat.update', $cat) }}" enctype="multipart/form-data" method="POST">
                                        @csrf
                                        <div class="card">
                                            <div class="card-body py-4">
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" value="{{ old('caretaker_id', $cat->caretaker_id) }}" name="caretaker_id" type="text" id="example-text-input">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="example-text-input" class="col-form-label">Cat ID</label>
                                                        <input class="form-control" value="{{ old('cat_id', $cat->cat_id) }}" name="cat_id" type="text" id="example-text-input">
                                                    </div>
    
                                                    <div class="col-md-6">
                                                        <label for="Name" class="col-form-label">Name</label>
                                                        <input class="form-control" value="{{ old('name', $cat->name) }}" name="name" type="text" placeholder="Enter Name" id="Name">
                                                    </div>
    
                                                    <div class="col-md-6">
                                                        <label for="address" class="col-form-label">Date of Birth</label>
                                                        <div class="input-group" id="datepicker1">
                                                            <input type="text" value="{{ old('date_birth', $cat->date_birth) }}" name="date_birth" class="form-control" placeholder="dd mm, yyyy" data-date-format="dd M, yyyy" data-date-container="#datepicker1" data-provide="datepicker"  data-date-autoclose="true">        
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" value="{{ old('fur_color', $cat->fur_color) }}" name="fur_color" class="form-control" id="FurColor" placeholder="Enter Fur / Color">
                                                    </div>

                                                    <div class="col-md-6">
                                                        <label for="EyeColor" class="col-form-label">Eye Color</label>
                                                        <input type="text" value="{{ old('eye_color', $cat->eye_color) }}" name="eye_color" class="form-control" id="EyeColor" placeholder="Enter Eye Color">
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" value="{{ old('origin', $cat->origin) }}" name="origin" class="form-control" placeholder="Enter Orgin">
                                                    </div>
    
                                                    <div class="col-md-6">
                                                        <label for="phone" class="col-form-label">Microchip Number</label>
                                                        <input class="form-control" value="{{ old('microchip_number', $cat->microchip_number) }}" name="microchip_number" type="text" placeholder="Enter Microchip Number" id="phone">
                                                    </div>
