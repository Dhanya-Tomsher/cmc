                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group" id="datepicker1">
                                            <input type="text" class="form-control" id="date_of_birth" readonly  name="date_of_birth">
                                ...
                                <form id="appointment" method="post" >
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="hidden" name="edit_vet_id" id="edit_vet_id" value="">
                                            <select class="form-select form-control"   id="vet_id" name="vet_id" style="width:100%;">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                <select class="form-select form-control select2"  id="appointment_time" name="appointment_time"  style="width:100%;">
    ...
    function editAppointment(app_id){
        $.ajax({
            ...
            success: function( response ) {
                ...
                getSlots(result.appointment[0].date_appointment,result.appointment[0].vet_id,result.appointment[0].time_appointment);
