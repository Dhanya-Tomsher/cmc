                                                ...
                                                <tr class="tr_{{ $i }}">
                                                    <td style="display:flex;">
                                                        <div class="col-md-6 col-sm-6">
                                                            ...
                                                            <input class="form-control procedure_field" name="procedure[]" value="{{ old('procedure', $inv['procedure']) }}" type="text" placeholder="Enter Procedure" data-id="{{ $i }}" id="procedure_{{ $i }}">
                                                        </div>
