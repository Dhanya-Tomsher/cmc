                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <form name="frm" action="{{ route('vet.store') }}" enctype="multipart/form-data" method="POST">
                                            <div class="row mb-3">
                                                <div class="col-6">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <textarea required="" name="ddress" class="form-control" placeholder="Enter address" rows="2"></textarea>
                                                </div>

                                                <div class="col-md-4">
                                                    <label for="email" class="col-form-label">Email ID</label>
                                                    <input class="form-control" name="name" type="email" placeholder="Enter Email ID" id="Email">
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input class="form-control" name="color_name" type="text" placeholder="Enter Color Name">
                                                </div>

                                                <div class="col-md-4">
                                                    <label class="col-form-label">Color Code</label>
                                                    <input class="form-control" name="color_code" type="text" placeholder="Enter Color Code">
                                                </div>

                                                <div class="col-md-4">
                                                    <label for="work-number" class="col-form-label">Emirates ID</label>
                                                    <input class="form-control" name="emirates_id" type="text" placeholder="Emirates ID" id="work-number">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="work-number" class="col-form-label">License Number</label>
                                                    <input class="form-control" name="license_number" type="text" placeholder="Licence Number" id="work-number">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="work-number" class="col-form-label">Designation</label>
                                                    <input class="form-control" name="designation" type="text" placeholder="Designation" id="work-number">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="work-number" class="col-form-label">Specialization</label>
                                                    <input class="form-control" name="specialization" type="text" placeholder="Emirates ID" id="work-number">
                                                </div>
