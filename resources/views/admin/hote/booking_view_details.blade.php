    ...
    <div class="tab-content py-3 text-muted">
        <div class="tab-pane " id="navtabs-care-taker-view" role="tabpanel">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control" type="text" value="{{ $hotel[0]->caretaker_emirate }}" readonly>
                </div>
        ...
        <div class="tab-pane" id="navtabs-cat-details-view" role="tabpanel">
            <div class="row">
                ...
                <div class="col-md-4">
                    <label for="country" class="col-form-label">Emirate</label>
                    <input type="text" class="form-control" value="{{ $hotel[0]->cat_emirate }}" readonly  rows="1"/>
                </div>
