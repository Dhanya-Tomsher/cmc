    ...
    <div id="sidebar-menu">
        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <li class="{{ Helper::areActiveRoutes(['service.index','service.create','service.view','service.edit']) }}">
                ...
                <ul class="sub-menu" aria-expanded="false">
                    <li class="{{ Helper::areActiveRoutes(['pricelist-categories.index','service.create','services','service.edit']) }}"><a href="{{ route('pricelist-categories.index') }}">Price List Categories</a></li>
