...
Route::get('caretaker/view',[CaretakerController::class,'view'])->name('caretaker.view');
...
Route::get('vet/view',[VetController::class,'view'])->name('vet.view');
Route::get('vet/edit',[VetController::class,'edit'])->name('vet.edit');
...
Route::post('vet/update',[VetController::class,'update'])->name('vet.update');
